...
interface FacultyRoomProps {
  totalFacultyRoom: number;
}

const FacultyRoomCard: React.FC<FacultyRoomProps> = ({ totalFacultyRoom }) => {
  return (
    <div className="flex flex-col items-center bg-blue-50 p-6 rounded-lg shadow-md w-64">
      ...
      <p className="text-gray-700 mt-4 text-lg font-medium">Faculty Rooms</p>
      <p className="text-gray-900 mt-2 text-2xl font-bold">
        {totalFacultyRoom}
      </p>
    </div>
  );
...
export default FacultyRoomCard;
